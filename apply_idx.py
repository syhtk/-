...
# Let's find index directly
idx_start = content.find('    def generate(')
idx_end = content.find('    def call_real_llm')

if idx_start != -1 and idx_end != -1:
    new_content = content[:idx_start] + rag_mock + content[idx_end:]
